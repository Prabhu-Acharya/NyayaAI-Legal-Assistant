...
function Login({ onLoginSuccess }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (!data.token) { setError(data.message || "Login failed."); setLoading(false); return; }
      onLoginSuccess(data.token, data.hasAcceptedTerms ?? false);
      ...
      <div style={S.card}>
        ...
        <div style={S.field}>
          ...
          <input
            ...
            style={S.input} value={formData.email}
        ...
        <div style={S.field}>
          ...
          <div style={{ position: "relative" }}>
            <input
              ...
              style={{ ...S.input, paddingRight: 44 }} value={formData.password}
              onChange={handleChange} onKeyDown={handleKeyDown}
              placeholder="••••••••"
            />
        ...
        <button style={{ ...S.submitBtn, opacity: loading ? 0.7 : 1 }} onClick={handleLogin} disabled={loading}>
          {loading ? (
        ...
        <p style={S.legalText}>
          By continuing, you agree to NyayaAI's{" "}
...
const S = {
  ...
  dividerText: { fontSize: "12px", color: "#aaa", fontWeight: "500", whiteSpace: "nowrap" },
  field:       { marginBottom: "16px" },
  label:       { fontSize: "13px", fontWeight: "500", color: "#444", display: "block" },
  input: {
  ...
  forgotLink:  { fontSize: "12px", color: "#6366f1", cursor: "pointer", fontWeight: "500" },
  eyeBtn: {
  ...
  submitBtn: {
    ...
    fontFamily: "inherit", marginBottom: "20px", transition: "background 0.15s",
  },
