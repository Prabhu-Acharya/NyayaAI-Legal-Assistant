...
export function ContractPreview({ contract, onNewContract, onEditDetails }) {
  ...
  const handleWhatsApp = () => {
    const preview = contract.content.slice(0, 1500);
    const message = `📄 *${contract.title}*\n\nGenerated by NyayaAI\n\n${preview}${contract.content.length > 1500 ? "\n\n[…truncated — download full PDF from NyayaAI]" : ""
      }`;
  ...
  return (
    <div style={styles.card}>
      ...
      <div style={localStyles.exportRow}>
        ...
        <button style={localStyles.btnWhatsapp} onClick={handleWhatsApp}>
          📲 Share on WhatsApp
        </button>
